...
export default function Nav() {
    return (
        <nav className="sticky top-0 z-10 flex justify-between items-center bg-white backdrop-blur-sm p-6 shadow-sm md:shadow-lg">
            ...
            <div className="text-xs md:text-lg text-slate-900">
